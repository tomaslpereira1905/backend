...
// .toArray();
// //Skip - Ignora o que estava na página anterior, e o limit serve para limitar o número de resultados por página
...
//                 totalPages: Math.ceil(bookIdArray.length / limit),
//             },
//         };
...
//       res.status(200).send(reviewsByJob);
//   } catch (erro) {
